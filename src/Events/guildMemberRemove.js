...
module.exports = {
  ...
  async execute(member) {
    ...
    let byeEmbed = new EmbedBuilder()
      ...
      .setFooter({
        text: `We are now a server with ${guild.memberCount} members \<3`,
      });
    ...
    try {
      ...
      console.log(err);
      console.log(
        "error on file guildMemberRemove. They prob removed the channel!"
      );
    }
    // sticky member remove
